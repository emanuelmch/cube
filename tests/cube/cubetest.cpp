...
void CubeTest::testRotateLeftFromShuffled() {
	...
	assertArrayEquals("Face LEFT:", left, oldLeft[6], oldLeft[3], oldLeft[0], oldLeft[7], oldLeft[4], oldLeft[1], oldLeft[8], oldLeft[5], oldLeft[2]);
	assertArrayEquals("Face RIGHT:", right, oldRight[0], oldRight[1], oldRight[2], oldRight[3], oldRight[4], oldRight[5], oldRight[6], oldRight[7], oldRight[8]);
	assertArrayEquals("Face UP:", up, oldBack[8], oldUp[1], oldUp[2], oldBack[5], oldUp[4], oldUp[5], oldBack[2], oldUp[7], oldUp[8]);
	assertArrayEquals("Face DOWN:", down, oldFront[0], oldDown[1], oldDown[2], oldFront[3], oldDown[4], oldDown[5], oldFront[6], oldDown[7], oldDown[8]);
	assertArrayEquals("Face FRONT:", front, oldUp[0], oldFront[1], oldFront[2], oldUp[3], oldFront[4], oldFront[5], oldUp[6], oldFront[7], oldFront[8]);
	assertArrayEquals("Face BACK:", back, oldBack[0], oldBack[1], oldDown[6], oldBack[3], oldBack[4], oldDown[3], oldBack[6], oldBack[7], oldDown[0]);
}
...
void CubeTest::testRotateRightFromShuffled() {
	...
	assertArrayEquals("Face RIGHT:", right, oldRight[6], oldRight[3], oldRight[0], oldRight[7], oldRight[4], oldRight[1], oldRight[8], oldRight[5], oldRight[2]);
	assertArrayEquals("Face LEFT:", left, oldLeft[0], oldLeft[1], oldLeft[2], oldLeft[3], oldLeft[4], oldLeft[5], oldLeft[6], oldLeft[7], oldLeft[8]);
	assertArrayEquals("Face UP:", up, oldUp[0], oldUp[1], oldFront[2], oldUp[3], oldUp[4], oldFront[5], oldUp[6], oldUp[7], oldFront[8]);
	assertArrayEquals("Face DOWN:", down, oldDown[0], oldDown[1], oldBack[6], oldDown[3], oldDown[4], oldBack[3], oldDown[6], oldDown[7], oldBack[0]);
	assertArrayEquals("Face FRONT:", front, oldFront[0], oldFront[1], oldDown[2], oldFront[3], oldFront[4], oldDown[5], oldFront[6], oldFront[7], oldDown[8]);
	assertArrayEquals("Face BACK:", back, oldUp[8], oldBack[1], oldBack[2], oldUp[5], oldBack[4], oldBack[5], oldUp[2], oldBack[7], oldBack[8]);
}
...
void CubeTest::testRotateBackFromShuffled() {
	...
	assertArrayEquals("Face BACK:", back, oldBack[6], oldBack[3], oldBack[0], oldBack[7], oldBack[4], oldBack[1], oldBack[8], oldBack[5], oldBack[2]);
	assertArrayEquals("Face FRONT:", front, oldFront[0], oldFront[1], oldFront[2], oldFront[3], oldFront[4], oldFront[5], oldFront[6], oldFront[7], oldFront[8]);
	assertArrayEquals("Face LEFT:", left, oldUp[2], oldLeft[1], oldLeft[2], oldUp[1], oldLeft[4], oldLeft[5], oldUp[0], oldLeft[7], oldLeft[8]);
	assertArrayEquals("Face RIGHT:", right, oldRight[0], oldRight[1], oldDown[8], oldRight[3], oldRight[4], oldDown[7], oldRight[6], oldRight[7], oldDown[6]);
	assertArrayEquals("Face UP:", up, oldRight[2], oldRight[5], oldRight[8], oldUp[3], oldUp[4], oldUp[5], oldUp[6], oldUp[7], oldUp[8]);
	assertArrayEquals("Face DOWN:", down, oldDown[0], oldDown[1], oldDown[2], oldDown[3], oldDown[4], oldDown[5], oldLeft[0], oldLeft[3], oldLeft[6]);
}
...
void CubeTest::testRotateDownFromShuffled() {
	...
	assertArrayEquals("Face DOWN:", down, oldDown[6], oldDown[3], oldDown[0], oldDown[7], oldDown[4], oldDown[1], oldDown[8], oldDown[5], oldDown[2]);
	assertArrayEquals("Face UP:", up, oldUp[0], oldUp[1], oldUp[2], oldUp[3], oldUp[4], oldUp[5], oldUp[6], oldUp[7], oldUp[8]);
	assertArrayEquals("Face LEFT:", left, oldLeft[0], oldLeft[1], oldLeft[2], oldLeft[3], oldLeft[4], oldLeft[5], oldBack[6], oldBack[7], oldBack[8]);
	assertArrayEquals("Face RIGHT:", right, oldRight[0], oldRight[1], oldRight[2], oldRight[3], oldRight[4], oldRight[5], oldFront[6], oldFront[7], oldFront[8]);
	assertArrayEquals("Face FRONT:", front, oldFront[0], oldFront[1], oldFront[2], oldFront[3], oldFront[4], oldFront[5], oldLeft[6], oldLeft[7], oldLeft[8]);
	assertArrayEquals("Face BACK:", back, oldBack[0], oldBack[1], oldBack[2], oldBack[3], oldBack[4], oldBack[5], oldRight[6], oldRight[7], oldRight[8]);
}
